...
console.log('Hoi! Ik ben ' + student1.firstName + ', ik ben ' + student1.currentAge + ' jaar oud.')
...
console.log('De Smeg Waterkoker is gemaakt van ' + product.material[0] + ' en ' + product.material[1] + '.')
